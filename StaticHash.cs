...
public static class StaticHash
{
	...
	public static long Compute128To64(long a, long b)
	{
		...
		return (long)((ulong)num2 ^ ((ulong)num2 >> 47)) * -7070675565921424023L;
	}
	...
	{
		int num = i + 1;
		int num2 = (int)((uint)num ^ ((uint)num >> 17)) * -312814405;
		int num3 = (int)((uint)num2 ^ ((uint)num2 >> 11)) * -1404298415;
		uint num4 = ((uint)num3 ^ ((uint)num3 >> 15)) * 830770091;
		return (int)(num4 ^ (num4 >> 14));
	}
